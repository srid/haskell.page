...
The generated HTML site can be previewed here: https://srid.github.io/haskellpage/
...
- As a first step to using this template, 
  - change the project name in .cabal, flake.nix and hie.yaml files; then commit changes to Git.
      - To automate this, `mv haskellpage.cabal myproject.cabal; nix run nixpkgs#sd -- haskellpage myproject * */* .github/*/*`
- Configuration:
...
- To generate static site, run: `nix build; mkdir ./output && (cd ./content  && ../result/bin/haskellpage gen $(pwd)/output)`
